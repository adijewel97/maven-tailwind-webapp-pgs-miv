 ...
 * Generated at: 2026-07-15 07:30:22 UTC
...
public final class mon02_005fcetak_005fstruk_005fmivbank_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("            // =======================\r\n");
      out.write("            // FILTER BERDASARKAN ID TRANSAKSI\r\n");
      out.write("            // =======================\r\n");
      ...
      out.write("        };\r\n");
      out.write("\r\n");
      out.write("        const parts = input.split(\" \");   // \"November 2025\" → [\"November\", \"2025\"]\r\n");
      out.write("        const bulan = bulanMap[parts[0]] || '';\r\n");
      out.write("        const tahun = parts[1] || '';\r\n");
      out.write("\r\n");
      out.write("        return tahun + bulan; // \"2025\" + \"11\" → \"202511\"\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // -------------------------\r\n");
      ...
      out.write("                });\r\n");
      out.write("                console.log(\"✅ Bank MIV berhasil dimuat:\", json.data.length, \"data\");\r\n");
      out.write("            } else {\r\n");
      out.write("                const opt = document.createElement('option');\r\n");
      ...
      out.write("                    select.appendChild(opt);\r\n");
      out.write("                });\r\n");
      out.write("                console.log(\"✅ DISWIL MIV berhasil dimuat:\", json.data.length, \"data\");\r\n");
      out.write("            } else {\r\n");
      out.write("                const opt = document.createElement('option');\r\n");
      ...
      out.write("                    select.appendChild(opt);\r\n");
      out.write("                });\r\n");
      out.write("                console.log(\"✅ UP3 MIV berhasil dimuat:\", json.data.length, \"data\");\r\n");
      out.write("            } else {\r\n");
      out.write("                const opt = document.createElement('option');\r\n");
      ...
      out.write("            showMessageDlg(\"Warning\", \"Silakan pilih BANK MIV terlebih dahulu!\");\r\n");
      out.write("            return;\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        const diswil = document.getElementById(\"diswil\").value;\r\n");
      ...
      out.write("            showMessageDlg(\"Warning\", \"Silakan pilih DISTRIBUSI/WILAYAH terlebih dahulu!\");\r\n");
      out.write("            return;\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        const up3 = document.getElementById(\"up3\").value;\r\n");
      ...
      out.write("            showMessageDlg(\"Warning\", \"Silakan pilih PILIH UP3 dahulu!\");\r\n");
      out.write("            return;\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      ...
      out.write("        console.log(\"📌 [PRINT] Tombol Print diklik\");\r\n");
      out.write("\r\n");
      out.write("        const list = document.getElementById(\"thelist\");\r\n");
      out.write("        console.log(\"📄 List element:\", list);\r\n");
      out.write("\r\n");
      out.write("        const selected = Array.from(list.selectedOptions).map(opt => opt.value);\r\n");
      out.write("        console.log(\"📂 File terpilih:\", selected);\r\n");
      out.write("\r\n");
      out.write("        if (selected.length === 0) {\r\n");
      out.write("            // alert(\"Silakan pilih minimal 1 file PDF!\");\r\n");
      out.write("            showMessageDlg(\"Warning\", \"Silakan pilih minimal 1 file PDF!\");\r\n");
      out.write("            return;\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("            console.log(`🔗 Download[");
      ...
      out.write("                console.log(`▶️ Membuka file[");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${index}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("]:`, filePath);\r\n");
      out.write("            }, index * 500);\r\n");
      out.write("        });\r\n");
