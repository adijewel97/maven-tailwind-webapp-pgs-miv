 ...
 * Generated at: 2026-07-16 07:40:42 UTC
...
public final class mon00_005fpendingmiv_005fap2tkep2apst_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            deferLoading: 0,   // <-- jangan load saat pertama kali\r\n");
      out.write("            ajax: {\r\n");
      ...
      out.write("                },\r\n");
      out.write("                // 1. Tangkap error jika server sukses merespons tapi membawa data error (JSON status)\r\n");
      out.write("                dataSrc: function (json) {\r\n");
      out.write("                    // Cek apakah ada code_message atau status bukan sukses\r\n");
      out.write("                    if (json.code && json.code !== 200) {\r\n");
      out.write("                        spinnerRekap.removeClass('flex').addClass('hidden');\r\n");
      out.write("                        \r\n");
      out.write("                        // Panggil fungsi showmessage Anda di sini\r\n");
      out.write("                        // Contoh format: showMessage(Judul, Pesan, Tipe)\r\n");
      out.write("                        if (typeof showMessage === \"function\") {\r\n");
      out.write("                            showMessageDlg(\"Error\", \"Error \" + json.code + \" - \" + json.code_message);\r\n");
      out.write("                        } else {\r\n");
      out.write("                            // alert(json.code_message); // Fallback jika fungsi belum terdefinisi\r\n");
      out.write("                             showMessageDlg(\"Warning\", json.code_message);\r\n");
      out.write("                        }\r\n");
      out.write("                        \r\n");
      out.write("                        return []; // Kembalikan array kosong agar DataTables tidak crash\r\n");
      out.write("                    }\r\n");
      out.write("                    return json.data; // Jika normal, kembalikan datanya\r\n");
      out.write("                },\r\n");
      out.write("                // 2. Tangkap error jika koneksi HTTP benar-benar putus / server mati (HTTP 500, 404, dll)\r\n");
      out.write("                error: function (xhr, error, thrown) {\r\n");
      out.write("                    spinnerRekap.removeClass('flex').addClass('hidden'); \r\n");
      out.write("                    \r\n");
      out.write("                    let errorMsg = \"Terjadi kesalahan pada server.\";\r\n");
      out.write("                    if (xhr.responseJSON && xhr.responseJSON.code_message) {\r\n");
      out.write("                        errorMsg = xhr.responseJSON.code_message;\r\n");
      out.write("                    }\r\n");
      out.write("                    \r\n");
      out.write("                    if (typeof showMessage === \"function\") {\r\n");
      ...
      out.write("                        // return row.URUT == 5 ? ' ' : text;\r\n");
      out.write("                        // return row.URUT == 5 ? `<strong>XXXX</strong>` : text;\r\n");
      out.write("                         if (row.URUT != 5) {\r\n");
      ...
      out.write("                },\r\n");
      out.write("                // { data: 'NAMA_DIST', defaultContent: '', width: '80px' },\r\n");
      ...
      out.write("                { targets: [1, 2, 7, 8], className: '!text-left' }, // Tambahkan tanda seru (!) untuk Tailwind\r\n");
      ...
      out.write("                    console.log($('td', row).eq(1).html());\r\n");
      out.write("                }\r\n");
      out.write("                \r\n");
      ...
      out.write("                const clickableColumns = [4, 5]; // Index kolom: PLN_IDPEL, PLN_RPTAG\r\n");
      ...
      out.write("                                    vkd_bank: data.NAMA_BANK ? data.NAMA_BANK.substring(0, 3) : '', // Ambil 3 karakter pertama bank\r\n");
      ...
      out.write("                    \r\n");
      out.write("                    // Mengubah nama Tab Sheet di Excel\r\n");
      out.write("                    $('sheet', xlsx.xl['workbook.xml']).attr('name', 'Rekap Pending');\r\n");
      out.write("                    \r\n");
      out.write("                    // 1. Ambil nilai dinamis judul\r\n");
      ...
      out.write("\r\n");
      out.write("                    // 2. Geser indeks baris asli bawaan DataTables ke bawah sebanyak 5 baris\r\n");
      out.write("                    var vawalData = 5;\r\n");
      out.write("                    $('row', sheet).each(function () {\r\n");
      out.write("                        var currentAttrRow = parseInt($(this).attr('r'));\r\n");
      out.write("                        var newAttrRow = currentAttrRow + vawalData; // Geser ke baris 6, dst\r\n");
      ...
      out.write("                    });\r\n");
      out.write("\r\n");
      out.write("                    // 🌟 PERBAIKAN AKURAT: Cari langsung string \"TOTAL\" di XML sheet Excel\r\n");
      out.write("                    $('row', sheet).each(function () {\r\n");
      out.write("                        var isTotalRow = false;\r\n");
      out.write("                        \r\n");
      out.write("                        // Cek apakah ada cell di baris ini yang berisi teks \"TOTAL\"\r\n");
      out.write("                        $(this).find('is t').each(function () {\r\n");
      out.write("                            if ($(this).text().trim() === 'TOTAL') {\r\n");
      out.write("                                isTotalRow = true;\r\n");
      out.write("                                return false; // break dari loop text\r\n");
      out.write("                            }\r\n");
      out.write("                        });\r\n");
      out.write("                        \r\n");
      out.write("                        // Jika ditemukan, ubah seluruh cell di baris ini menjadi BOLD (s=\"2\")\r\n");
      out.write("                        if (isTotalRow) {\r\n");
      out.write("                            $(this).find('c').each(function () {\r\n");
      out.write("                                $(this).attr('s', '2'); // s=\"2\" adalah style default bold DataTables\r\n");
      out.write("                            });\r\n");
      out.write("                        }\r\n");
      out.write("                    });\r\n");
      out.write("\r\n");
      out.write("                    // 3. Susun XML baris judul baru dengan tambahan s=\"2\" untuk BOLD\r\n");
      ...
      out.write("                        '</row>';\r\n");
      out.write("\r\n");
      out.write("                    // 4. Masukkan judul ke bagian paling atas sheetData\r\n");
      ...
      out.write("            ajax: {\r\n");
      out.write("                url: getContextPath() + '/mon-pending-ap2tkep2apst', // ✅ Double slash (//) sudah diperbaiki menjadi single slash (/)\r\n");
      out.write("                type: 'POST',\r\n");
      out.write("                data: function (d) {\r\n");
      ...
      out.write("                    // Cek apakah ada code_message atau status bukan sukses\r\n");
      out.write("                    if (json.code && json.code !== 200) {\r\n");
      out.write("                        // 1. Matikan spinner loading\r\n");
      out.write("                        if (typeof hideSpinner === \"function\") {\r\n");
      out.write("                            hideSpinner();\r\n");
      out.write("                        } else if (typeof spinnerDetail !== 'undefined') {\r\n");
      out.write("                            spinnerDetail.removeClass('flex').addClass('hidden');\r\n");
      out.write("                        }\r\n");
      out.write("                        \r\n");
      out.write("                        // 2. Tutup modal detail agar user tidak melihat tabel kosong\r\n");
      ...
      out.write("                    } else {\r\n");
      out.write("                        // alert(errorMsg);\r\n");
      out.write("                        showMessageDlg(\"Warning\", errorMsg);\r\n");
      out.write("                    }\r\n");
      out.write("                }\r\n");
      out.write("            },\r\n");
      out.write("            columns: [\r\n");
      ...
      out.write("                // { data: 'ROW_NUMBER', defaultContent: '' },\r\n");
      out.write("                // { data: 'TOTAL_COUNT', defaultContent: '' }\r\n");
      out.write("            ],\r\n");
      out.write("            columnDefs: [\r\n");
      ...
      out.write("                        return 'MIV_PENDING_DETAIL_'+ dist +'_' + bln;\r\n");
      out.write("                    },\r\n");
      out.write("                    className: 'd-none',\r\n");
      out.write("                    exportOptions: {\r\n");
      ...
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        table_rekap_pending.on('xhr.dt', function () {\r\n");
      out.write("            spinnerRekap.removeClass('flex').addClass('hidden');   \r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                // 🟢 PEMBUATAN TIMESTAMP KEMBALI DISEDIAKAN DI SINI\r\n");
      ...
      out.write("\r\n");
      out.write("                // Styling untuk Judul Utama (B1 & B2) -> BOLD & UKURAN BESAR\r\n");
      out.write("                ['B1', 'B2'].forEach(cellRef => {\r\n");
      out.write("                    worksheet.getCell(cellRef).font = { bold: true, size: 12, name: 'Arial' };\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // Styling untuk Label Info (B3 sampai B8) -> BOLD\r\n");
      out.write("                for (let i = 3; i <= 8; i++) {\r\n");
      out.write("                    worksheet.getCell('B' + i).font = { bold: true, name: 'Arial' };\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                // 2. Tambahkan Header Tabel di Baris 10 (Mulai Kolom A / Kolom 1)\r\n");
      out.write("                const tableHeaders = ['NO', ...Object.values(headers)];\r\n");
      out.write("                const headerRow = worksheet.getRow(10);\r\n");
      out.write("                headerRow.values = tableHeaders;\r\n");
      out.write("                \r\n");
      out.write("                // Styling untuk Header Tabel -> BOLD, Background Biru Lembut, Text Center\r\n");
      out.write("                headerRow.eachCell((cell) => {\r\n");
      out.write("                    cell.font = { bold: true, color: { argb: 'FFFFFF' }, name: 'Arial' };\r\n");
      out.write("                    cell.fill = {\r\n");
      out.write("                        type: 'pattern',\r\n");
      out.write("                        pattern: 'solid',\r\n");
      out.write("                        fgColor: { argb: '4F81BD' }\r\n");
      out.write("                    };\r\n");
      out.write("                    cell.alignment = { vertical: 'middle', horizontal: 'center' };\r\n");
      out.write("                });\r\n");
      out.write("                headerRow.height = 25;\r\n");
      out.write("\r\n");
      out.write("                // 3. Tambahkan Data Detail (Mulai Baris 11)\r\n");
      out.write("                allData.forEach((row, index) => {\r\n");
      out.write("                    const dataRowValues = [index + 1];\r\n");
      out.write("                    Object.keys(headers).forEach(key => {\r\n");
      out.write("                        dataRowValues.push(row[key]);\r\n");
      out.write("                    });\r\n");
      out.write("                    \r\n");
      out.write("                    worksheet.addRow(dataRowValues);\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // 4. Auto-fit lebar kolom agar rapi tidak terpotong (###)\r\n");
      out.write("                worksheet.columns.forEach(column => {\r\n");
      out.write("                    let maxLen = 0;\r\n");
      out.write("                    column.eachCell({ includeEmpty: false }, (cell) => {\r\n");
      out.write("                        const cellLen = cell.value ? cell.value.toString().length : 0;\r\n");
      out.write("                        if (cellLen > maxLen) maxLen = cellLen;\r\n");
      out.write("                    });\r\n");
      out.write("                    column.width = maxLen < 10 ? 10 : maxLen + 3;\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // 5. Generate File dan Trigger Download via FileSaver.js\r\n");
      out.write("                const fileName = \"MIV_PENDING_DETAIL_\" + vkd_dist + \"_\" + vbln_usulan + \".xlsx\";\r\n");
      ...
      out.write("                showMessageDlg(\"Warning\", \"Gagal mengekspor data: \" + error.message);\r\n");
      out.write("            } finally {\r\n");
      out.write("                btn.prop('disabled', false).html('<i class=\"fa fa-file-excel\"></i> <span>Export Detail Per-UPI</span>');\r\n");
      out.write("                spinnerDetail.removeClass('flex').addClass('hidden');\r\n");
      out.write("            }\r\n");
