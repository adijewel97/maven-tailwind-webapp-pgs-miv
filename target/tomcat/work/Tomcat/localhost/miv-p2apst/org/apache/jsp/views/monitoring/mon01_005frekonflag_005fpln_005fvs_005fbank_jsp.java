 ...
 * Generated at: 2026-08-11 23:32:39 UTC
...
public final class mon01_005frekonflag_005fpln_005fvs_005fbank_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    hideSpinner();\r\n");
      out.write("                    console.log(\"DataTables Ajax Error:\", error, thrown);\r\n");
      out.write("                }\r\n");
      out.write("            },\r\n");
      out.write("            columns: [\r\n");
      out.write("                { data: null, render: function (data, type, row, meta) { return row.URUT != 5 ? meta.row + 1 : ''; } },\r\n");
      out.write("                { data: null, render: function (data, type, row) { const text = row.KD_DIST && row.NAMA_DIST ? row.KD_DIST + ' - ' + row.NAMA_DIST : ''; return row.URUT != 5 ? text : ''; } },\r\n");
      out.write("                { data: 'PRODUK', defaultContent: '' },\r\n");
      out.write("                { data: 'BANK', defaultContent: '' },\r\n");
      out.write("                { data: 'BLN_USULAN', defaultContent: '' },\r\n");
      out.write("                { data: 'PLN_IDPEL', render: function (data) { return formatNumber(data, 0); } },\r\n");
      out.write("                { data: 'PLN_RPTAG', render: function (data) { return formatNumber(data, 0); } },\r\n");
      out.write("                { data: 'PLN_LEBAR_LUNAS', render: function (data) { return formatNumber(data, 0); } },\r\n");
      out.write("                { data: 'PLN_RPTAG_LUNAS', render: function (data) { return formatNumber(data, 0); } },\r\n");
      out.write("                { data: 'BANK_IDPEL', render: function (data) { return formatNumber(data, 0); } },\r\n");
      ...
      out.write("                { targets: [1, 2, 3], className: '!text-left' }, \r\n");
      ...
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 🌟 4) DataTables Detail (table_mondaf_rekonupi) - SESUAIKAN DENGAN PENDING\r\n");
