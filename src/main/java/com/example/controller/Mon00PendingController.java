...
import com.example.service.MonPendingService;
...
@WebServlet(name = "Mon00PendingController", urlPatterns = {"/mon-pending-ap2tkep2apst"})
public class Mon00PendingController extends HttpServlet {
    // private MonRekonPerUpiService service;
    private MonPendingService servicepending;
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            servicepending = new MonPendingService(dbService.getDataSource());
        } catch (Exception e) {
    ...
    private void prosesMonRekapPerUpi(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            data = servicepending.getDataMonRkpPending(vbln_usulan, pesanMsg, statusMsg);
    ...
    private void handleGetNamaBank(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try (PrintWriter out = resp.getWriter()) {
            Map<String, Object> UnitUPIData = servicepending.getDataBank(kdbank); // Panggil ke service
    ...
    private void handleGetNamaUnitUPI(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try (PrintWriter out = resp.getWriter()) {
            Map<String, Object> UnitUPIData = servicepending.getDataUnitUPI(kd_dist); // Panggil ke service
            result.put("status", "success");
            result.put("data", UnitUPIData);
            out.print(gson.toJson(result));
        } catch (Exception e) {
